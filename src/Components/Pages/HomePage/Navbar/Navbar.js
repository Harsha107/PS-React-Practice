...
function Navbar() {
    ...
    return (
        <nav className='navbar'>
            ...
            <ul className={Mobile ? 'uList-mobile' : 'uList'} onClick={() => setMobile(false)}>
                <li><a id='home' href='/'>HOME</a></li>
                <li><a id='collections' href='/collections/all'>COLLECTIONS</a></li>
                <li><a id='community-nav' href='/community'>COMMUNITY</a></li>
                <li><a id='search-bar' href='/search'><FaSearch/></a></li>
                <li><a id='acc' href='/login'><VscAccount></VscAccount></a></li>
            </ul>
